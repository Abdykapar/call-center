                ...
                <div class="card">
                    <form class="form" @submit.prevent="handleSubmit" >
                        ...
                        <div class="card-body card-block">
                                ...
                                <label for="title" class="pr-1  form-control-label">Name</label>
                                <input type="text" v-validate="'required'" id="title" v-model="country.title" class="form-control" :class="{ 'is-invalid': submitted && errors.has('title') }">
                                </div>
...
import { countryService } from "../../../_services/location/country.service";
...
export default {
  ...
  created() {
        countryService.getById(this.$route.params.id)
            .then(result => {
                        console.log(result);
                        this.country.id = result.id;
                        this.country.title = result.title;
            })
            .catch(err => {
                        console.log(err);
            });
